<x-app-layout>
    ...
    <div class="card ">
        <div class="card-header">{{ $community->name }}: se creará un post en esta comunidad</div>
        ...
        <div class="card-body">
            <form method="POST"
                ...
                <div class="form-control justify-content-center">
                    <label for="title" class="col-md-4 col-form-label text-md-right">{{ __('Titulo de nueva publicación en comunidad: '.$community->name) }}</label>

                    <div class="col-md-6">
                        <input id="title" type="text" class="input input-bordered input-primary input-lg w-full max-w-xs form-control @error('title') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <textarea rows="10" class="textarea textarea-primary form-control @error('post_text') is-invalid @enderror"
